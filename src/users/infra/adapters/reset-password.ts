...
export class ResetPassword {
	...
	@MaxLength(64, { message: "New password should have at most 64 characters" })
	new_password: string;

	@ApiProperty({ example: "123456" })
	@IsNotEmpty({ message: "Confirm password should not be empty" })
	@MinLength(6, { message: "Confirm password should have at least 6 characters" })
	@MaxLength(64, { message: "Confirm password should have at most 64 characters" })
